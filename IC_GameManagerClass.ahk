...
#include IC_GameManager_Class.ahk
...
class GameManager
{
    ...
    Refresh()
    {
        ...
        this.Game.GameInstance.Controller.UserData.HeroHandler.HeroList.UpgradeCountAlias := New GameObjectStructure(this.Game.GameInstance.Controller.UserData.HeroHandler.HeroList,, [0x114, 0x18]) ; Alias 
        this.Game.GameInstance.Controller.UserData.HeroHandler.HeroList.HealthAlias := New GameObjectStructure(this.Game.GameInstance.Controller.UserData.HeroHandler.HeroList, "Double", [0x1E8]) ; Alias 
        this.Game.GameInstance.Controller.UserData.HeroHandler.HeroList.SlotAlias := New GameObjectStructure(this.Game.GameInstance.Controller.UserData.HeroHandler.HeroList,, [0x188]) ; Alias
        this.Game.GameInstance.Controller.UserData.HeroHandler.HeroList.BenchAlias := New GameObjectStructure(this.Game.GameInstance.Controller.UserData.HeroHandler.HeroList,, [0x194]) ; Alias
        this.Game.GameInstance.Controller.UserData.HeroHandler.HeroList.LevelAlias := New GameObjectStructure(this.Game.GameInstance.Controller.UserData.HeroHandler.HeroList,, [0x1b0]) ; Alias
        ...
        this.Game.GameInstance.Screen.uiController := New GameObjectStructure(this.Game.GameInstance.Screen,, [0x268])
        this.Game.GameInstance.Screen.uiController.topBar := New GameObjectStructure(this.Game.GameInstance.Screen.uiController,, [0xC])
        this.Game.GameInstance.Screen.uiController.topBar.objectiveProgressBox := New GameObjectStructure(this.Game.GameInstance.Screen.uiController.topBar,, [0x234])
        this.Game.GameInstance.Screen.uiController.topBar.objectiveProgressBox.areaBar := New GameObjectStructure(this.Game.GameInstance.Screen.uiController.topBar.objectiveProgressBox,, [0x250])
        ;this.Game.GameInstance.Screen.uiController.topBar.objectiveProgressBox.areaBar.autoProgressButtonToggled := New GameObjectStructure([0xAD0, 0x34, 0x90, 0x690, 0x5d0, 0x40, 0x23c]) ; Push autoProgressButton.toggled
        this.Game.GameInstance.Screen.uiController.topBar.objectiveProgressBox.areaBar.autoProgressButtonToggled := New GameObjectStructure(this.Game.GameInstance.Screen.uiController.topBar.objectiveProgressBox.areaBar, "Char", [0x238, 0x272]) ; Push autoProgressButton.toggled
    }
} 
...
class GameManagerEGS
{
    ...
    Refresh()
    {
        ...
        this.Game.ActiveScreen.Width := New GameObjectStructure(this.Game.ActiveScreen,, [0x33c]) 
        this.Game.ActiveScreen.Height := New GameObjectStructure(this.Game.ActiveScreen,, [0x340])
        ;=========================================================
        ;herohandler - champion related information accessed by ID
        ;=========================================================
        ...
        this.Game.GameInstance.Controller.UserData.HeroHandler.HeroList.UpgradeCountAlias := New GameObjectStructure(this.Game.GameInstance.Controller.UserData.HeroHandler.HeroList,, [0x228, 0x40]) ; Alias 
        ...
        this.Game.GameInstance.Controller.UserData.HeroHandler.HeroList.LevelAlias := New GameObjectStructure(this.Game.GameInstance.Controller.UserData.HeroHandler.HeroList,, [0x324]) ; Alias
        this.Game.GameInstance.Controller.UserData.HeroHandler.HeroList.SeatAlias := New GameObjectStructure(this.Game.GameInstance.Controller.UserData.HeroHandler.HeroList,, [0x18, 0x138]) ; Alias
        ;=============================
        ;GameUser - userid, hash, etc. (Depricated. Used GameSettings class to access these values)
        ;=============================
        ...
        this.Game.GameInstance.FormationSaveHandler.FormationSavesList.FavoriteAlias := New GameObjectStructure(this.Game.GameInstance.FormationSaveHandler.FormationSavesList,, [0x50]) 
        ...
        this.Game.GameInstance.FormationSaveHandler.FormationSavesList.FormationNameAlias := New GameObjectStructure(this.Game.GameInstance.FormationSaveHandler.FormationSavesList, "UTF-16", [0x30, 0x18])  ; F???
        ;=========================================================================
        ;Formation related memory reads (not save, but the in adventure formation)
        ;=========================================================================
        ...
        this.Game.GameInstance.Screen.uiController := New GameObjectStructure(this.Game.GameInstance.Screen,, [0x3a0])
        ...
        this.Game.GameInstance.Screen.uiController.topBar.objectiveProgressBox := New GameObjectStructure(this.Game.GameInstance.Screen.uiController.topBar,, [0x340])
        this.Game.GameInstance.Screen.uiController.topBar.objectiveProgressBox.areaBar := New GameObjectStructure(this.Game.GameInstance.Screen.uiController.topBar.objectiveProgressBox,, [0x378])
        this.Game.GameInstance.Screen.uiController.topBar.objectiveProgressBox.areaBar.autoProgressButtonToggled := New GameObjectStructure(this.Game.GameInstance.Screen.uiController.topBar.objectiveProgressBox.areaBar, "Char", [0x348, 0x39a]) ; Push autoProgressButton.toggled
    }
} 
